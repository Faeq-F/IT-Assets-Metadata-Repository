...
export async function makeType(toastStore: { trigger: (arg0: { message: string; background: string; timeout: number; }) => void; }, fieldsSaved: any[]) {
...
export function addMetadataField(toastStore: { trigger: (arg0: { message: string; background: string; timeout: number; }) => void; }, fieldsSaved: any[], fieldListable: boolean): any[] {
