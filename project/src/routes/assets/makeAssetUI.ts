...
function generateInputForType(fieldObject: any):string {
	...
	if (fieldObject.list) {
		switch (fieldObject.dataType) {
			case "Text":
				input = '<p></p><input type="text" placeholder="please ensure there is a \', \' (Comma + Space) between the text values" class="input w-11/12" id="' +
					fieldObject.field +
				...
				break;
			case "Number":
				input = '<input type="text" placeholder="please ensure there is a \', \' (Comma + Space) between the number values" pattern="\d*" class="input w-11/12" id="' +
					fieldObject.field +
		...
		switch (fieldObject.dataType) {
			case "Text":
				input = '<input type="text" class="input w-96" id="' +
					fieldObject.field +
					'" name="' +
					fieldObject.field +
					'" /><br /><br />';
				break;
			case "Number":
				input = '<input type="number" class="input w-96" id="' +
					fieldObject.field +
					'" name="' +
					fieldObject.field +
					'" /><br /><br />';
